<template>
 <div>
    ...
    <Card>
      ...
      <hr>
      <p style="font-size:11px;">外部交易所行情获取：https://apis.bizzan.vip/ermarket/thumb/btcusdt</p>
      <p style="font-size:11px;">获取所有机器人配置：https://apis.bizzan.vip/ernormal/robotList</p>
      <Modal
        v-model="ifDelete"
        title="删除交易对"
        @on-ok="confirmDel"
