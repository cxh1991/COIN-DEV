module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于BITSPIE",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "BITSPIE.PRO由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "BITSPIE.PRO定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "BITSPIE官方新手入门辅助通道",
        oneminutebuy: "法币通道",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归比特派(WWWW.BITSPIE.COM)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（www.bitspie.com）",
        tipsmobile1: "请在电脑端打开（www.bitspie.com）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"比特派(WWWW.BITSPIE.COM)的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与比特派(WWWW.BITSPIE.COM)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，比特派(WWWW.BITSPIE.COM)推出【推广合伙人】计划，该活动长期有效。",
        ...
        ruletext8: "八、推广返佣排行榜TOP10或TOP100不定期会获得由比特派(WWWW.BITSPIE.COM)官方发放的额外奖励。",
        ruletext9: "九、如其他活动与【推广合伙人】活动冲突，则经协商后决定是否临时变更，望诸合伙人谅解。",
        ruletext10: "十、L4(巡抚)、L5(太守)、L6(节度使)级合伙人分别享受每年返佣总额的5%、10%、15%的分红奖励。",
        ruletext11: "十一、本活动最终解释权归比特派(WWWW.BITSPIE.COM)所有。",
        ...
        thanks: "感谢您陪着比特派(WWWW.BITSPIE.COM)一起成长！",
        headertip: "以上佣金数据非实时更新，系统每24H统计并更新一次。",
        ptools: "推广工具箱",
        pt_title: "数字货币礼品卡",
        pt_desc: "兑换后自动成为下级好友，送朋友、送亲人、送客户、送伙伴。助力推广合伙人更好推广。",
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@bitspie.com，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由比特派(WWWW.BITSPIE.COM)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归BITSPIE.PRO所有。",
        pt_card_day: "天",
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "比特派APP - 全球数字资产交易平台"
    },
    description: {
        ...
        message5: '比特派(WWWW.BITSPIE.COM)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "比特派(WWWW.BITSPIE.COM)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。比特派(WWWW.BITSPIE.COM)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "比特派(WWWW.BITSPIE.COM)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "比特派(WWWW.BITSPIE.COM)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "比特派(WWWW.BITSPIE.COM)严格筛选优质项目并提供安全稳定的资产托管服务。比特派(WWWW.BITSPIE.COM)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        community: "比特派社区",
        wechat: "微信",
        addwechat: "添加 “BITSPIE01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与BITSPIE社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "BITSPIE账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于BITSPIE收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，BITSPIE会拿出平台的80% (扣除税费后) 的收入分配给BITSPIE持有者，20%的收入用来支持平台的研发及运营。",
