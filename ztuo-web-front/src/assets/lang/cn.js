module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "WWWW.BITSPIE.COM由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "WWWW.BITSPIE.COM定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
    ...
    activity: {
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（WWWW.BITSPIE.COM）",
        tipsmobile1: "请在电脑端打开（WWWW.BITSPIE.COM）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归WWWW.BITSPIE.COM所有。",
        pt_card_day: "天",
