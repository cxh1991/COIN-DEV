module.exports = {
    ...
    sectionPage: {
        ...
        brandTitle: "About BITSPIE",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "BITSPIE was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "BITSPIE is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "BITSPIE Official Customer Service",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by BITSPIE, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of BITSPIE.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.bitspie.com）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with BITSPIE trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, BITSPIE launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to BITSPIE.",
        ...
        thanks: "Thank you for supporting BITSPIE！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@bitspie.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to BITSPIE.PRO.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become BITSPIE Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "BITSPIE APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "BITSPIE.PRO is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of BITSPIE.PRO come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "BITSPIE.PRO platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, BITSPIE.PRO adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "BITSPIE.PRO strictly screens high-quality projects and provides secure and stable asset hosting services. BITSPIE.PRO upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
    ...
    index: {
        ...
        BHBregister: "BITSPIE account registration",
        ...
        fenpeijizhi: 'A description of the BITSPIE income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, BITSPIE will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
