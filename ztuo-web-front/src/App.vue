            ...
            <div class="header_nav">
              <Menu :active-name="activeNav" width="auto" :open-names="['1']">
                <Submenu name="1">
                  ...
                  <router-link to="/option" style="display: none;">
    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          ...
          <p>Copyright © 2012-2021 WWWW.BITSPIE.COM All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://twitter.com/BITSPIEGlobal" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@BITSPIE" theme="dark" placement="top">
                <li>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">service@bitspie.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@bitspaie.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">list@bitspaie.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">ceo@bitspaie.com</p>
                </div>
              </poptip>
            </li>
          </ul>
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "zh_CN" ? "交易中心" : "Exchange") + " - BITSPIE | BITSPIE | Global digital currency trading platform";
          break;
        case "nav-service":
          window.document.title = (this.lang == "zh_CN" ? "公告" : "Announcement") + " - BITSPIE | BITSPIE | Global digital currency trading platform";
          break;
        case "nav-about":
          window.document.title = (this.lang == "zh_CN" ? "关于" : "About") + " - BITSPIE | BITSPIE | Global digital currency trading platform";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "zh_CN" ? "创新实验室" : "Lab") + " - BITSPIE | BITSPIE | Global digital currency trading platform";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "zh_CN" ? "推广合伙人" : "Promotion") + " - BITSPIE | BITSPIE | Global digital currency trading platform";
          break;
	case "nav-cexchange":
          window.document.title = (this.lang == "zh_CN" ? "活动" : "Activity") + " - BITSPIE | Global digital currency trading platform";
          break;
        default:
          window.document.title = "BITSPIE | BITSPIE - - Global digital currency trading platform";
          break;
      }
    },
    $route(to, from) {
