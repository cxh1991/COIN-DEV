    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@bitspie.com</p>
          <p>{{$t('description.support')}}：support@bitspaie.com</p>
          <p>{{$t('description.apply')}}：apply@bitspaie.com</p>
          <p>{{$t('description.report')}}：ceo@bitspaie.com</p>
          <p>{{$t('description.coop')}}：coop@bitspaie.com</p>
        </div>
