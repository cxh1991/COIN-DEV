  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">BITSPIE</p>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://test.seaex.vip/2019/08/08/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "BITSPIE | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://test.seaex.vip/appdownload/BITSPIE.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
        ...
        location.href = "https://down.qiyeqp.com:8004/yXYG.app";
      }
    },
    coverClick(){
